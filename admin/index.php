...
<body class="materialdesign"><div class="wrapper-pro">
	...
	$ctrg=0;
	$datacolumn="";
	$q = mysqli_query($con,"select * from tbl_department");
	  while($r=mysqli_fetch_array($q)){
		  $groups = $groups ."['". $r['fld_deptcode'] . "'],";
		  $fld_deptcode = $r['fld_deptcode'];
		    $x = mysqli_query($con,"select * from tbl_lpofiles where fld_departmentuploader='$fld_deptcode'");
			$ilanba = mysqli_num_rows($x);
			$datacolumn=$datacolumn . "['" . $fld_deptcode ."',". $ilanba ."],";
		  $ctrg++;
	  }
	  if($ctrg>0){
		 $groups= rtrim($groups, ", ");
	 ...
	 $lpoctr=mysqli_num_rows($q);
	 
	 $q = mysqli_query($con,"select * from tbl_users");
	 $userctr=mysqli_num_rows($q);
	 
	 $q = mysqli_query($con,"select * from tbl_lpocategory");
	 $catrctr=mysqli_num_rows($q);
	 
	 $q = mysqli_query($con,"select * from tbl_department");
	 $deptctr=mysqli_num_rows($q);
	?>
                        ...
                        <div class="income-dashone-pro">
                            <div class="income-rate-total">
                                <div class="price-adminpro-rate">
                                    <h3><span class="counter"><?php echo $lpoctr; ?></span></h3>
                                </div>
                            ...
                            <div class="income-range">
                                <p>Number of LPOs</p>
                                <span class="income-percentange"> <i class="fa fa-folder"></i></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="income-dashone-total shadow-reset nt-mg-b-30">
                        ...
                        <div class="income-dashone-pro">
                            <div class="income-rate-total">
                                <div class="price-adminpro-rate">
                                    <h3><span class="counter"><?php echo $userctr; ?></span></h3>
                                </div>
                                <div class="price-graph">
                            ...
                            <div class="income-range order-cl">
                                <p>Number of Users</p>
                                <span class="income-percentange"> <i class="fa fa-user"></i></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="income-dashone-total shadow-reset nt-mg-b-30">
                        ...
                        <div class="income-dashone-pro">
                            <div class="income-rate-total">
                                <div class="price-adminpro-rate">
                                    <h3><span class="counter"><?php echo $catrctr; ?></span></h3>
                                </div>
                                <div class="price-graph">
                            ...
                            <div class="income-range visitor-cl">
                                <p>Number of LPO Categories</p>
                                <span class="income-percentange"> <i class="fa fa-file"></i></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="income-dashone-total shadow-reset nt-mg-b-30">
                        ...
                        <div class="income-dashone-pro">
                            <div class="income-rate-total">
                                <div class="price-adminpro-rate">
                                    <h3><span class="counter"><?php echo $deptctr; ?></span></h3>
                                </div>
                                <div class="price-graph">
                            ...
                            <div class="income-range low-value-cl">
                                ...
                                <span class="income-percentange"> <i class="fa fa-building"></i></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1>Number of LPOs by Department</h1>
                            </div>
                            </div>
